...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL, URLSearchParams) {/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted() {
    ...
    const searchSort = url.searchParams.get('sort'); // re-populate filters
  ...
  methods: {
    ...
    async getSpecies() {
      await this.$store.dispatch('species/fetchPagedSpecies', this.filters); // push uri
    ...
    sideFilters(args) {
      ...
      if (this.filters[args.name] == null) this.deleteUriParam(args.name);else {
        // push uri
        const searchURL = new URL(window.location);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(231)["URL"], __webpack_require__(231)["URLSearchParams"]))
...
module.exports.__inject__ = function (context) {
  add("0fefe766", content, true, context)
};
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".text-search.v-text-field fieldset{border:2px solid #08527b!important;color:#08527b}.text-search.v-text-field i{color:#08527b}.text-search.v-text-field input::-moz-placeholder{color:#08527b;opacity:1}.text-search.v-text-field input:-ms-input-placeholder{color:#08527b;opacity:1}.text-search.v-text-field input::placeholder{color:#08527b;opacity:1}.text-search.v-text-field input::-ms-input-placeholder{color:#08527b}.select-filter fieldset{background-color:#08527b!important;border:2px solid #08527b!important}.select-filter .v-select__selections .v-select__selection{color:#fff!important}.select-filter .theme--light.v-label.v-label--active{margin-top:10px!important}.select-filter .theme--light.v-icon,.select-filter .theme--light.v-label{color:#fff!important}", ""]);
// Exports
module.exports = exports;
...
"use strict";
/* harmony import */ var _src_components_VSkeletonLoader_VSkeletonLoader_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(265);
...
/* harmony import */ var _mixins_elevatable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/species/index.vue?vue&type=template&id=1bad2cff&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"px-md-16 px-6 pb-16"},[_c('v-row',[_c('v-col',{attrs:{"cols":"12","md":"3"}},[_c('div',{staticClass:"grey lighten-4 rounded-xl pa-5 pb-0",staticStyle:{"position":"sticky","top":"90px"}},[_c('div',{staticClass:"pb-3 pl-1 text-overline",staticStyle:{"font-size":"18px !important"}},[_c('div',{staticClass:"avenir-black electric_blue--text"},[_vm._v("Filters")])]),_vm._v(" "),_c('v-text-field',{staticClass:"rounded-xl pa-0 ma-0 text-search",attrs:{"outlined":"","label":"Search","prepend-inner-icon":"mdi-magnify","color":"electric_blue"},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.sideFilters({name: 'keyword'})}},model:{value:(_vm.filters.keyword),callback:function ($$v) {_vm.$set(_vm.filters, "keyword", $$v)},expression:"filters.keyword"}}),_vm._v(" "),_c('v-select',{staticClass:"rounded-xl select-filter",attrs:{"items":_vm.sortNames,"item-text":"name","item-value":"value","label":"Sort","outlined":"","clearable":"","bg-color":"purple"},on:{"change":function($event){return _vm.sideFilters({name: 'sort'})}},model:{value:(_vm.filters.sort),callback:function ($$v) {_vm.$set(_vm.filters, "sort", $$v)},expression:"filters.sort"}}),_vm._v(" "),_c('v-select',{staticClass:"rounded-xl select-filter",attrs:{"items":_vm.shell_class || [],"item-text":"name","item-value":"classid","label":"Class","outlined":"","clearable":""},on:{"change":function($event){return _vm.sideFilters({name: 'shell_class'})}},model:{value:(_vm.filters.shell_class),callback:function ($$v) {_vm.$set(_vm.filters, "shell_class", $$v)},expression:"filters.shell_class"}}),_vm._v(" "),(_vm.filters.shell_class)?_c('v-select',{staticClass:"rounded-xl select-filter",attrs:{"items":_vm.family || [],"item-text":"name","item-value":"familyid","label":"Family","outlined":"","clearable":""},on:{"change":function($event){return _vm.sideFilters({name: 'family'})}},model:{value:(_vm.filters.family),callback:function ($$v) {_vm.$set(_vm.filters, "family", $$v)},expression:"filters.family"}}):_vm._e(),_vm._v(" "),(_vm.filters.shell_class)?_c('v-select',{staticClass:"rounded-xl select-filter",attrs:{"items":_vm.genus || [],"item-text":"name","item-value":"genusid","label":"Genus","outlined":"","clearable":"","bg-color":"purple"},on:{"change":function($event){return _vm.sideFilters({name: 'genus'})}},model:{value:(_vm.filters.genus),callback:function ($$v) {_vm.$set(_vm.filters, "genus", $$v)},expression:"filters.genus"}}):_vm._e()],1)]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"9"}},[(_vm.loading)?_c('div',[_c('v-sheet',{staticClass:"pa-3"},[_c('v-row',_vm._l((3),function(i){return _c('v-col',{key:i,attrs:{"cols":"12","md":"4"}},[_c('v-skeleton-loader',{attrs:{"type":"card"}})],1)}),1)],1)],1):((_vm.paged_species && _vm.paged_species.data) && _vm.paged_species.data.data.length > 0)?_c('div',[_c('v-layout',{attrs:{"wrap":"","align-center":"","row":"","fill-height":""}},_vm._l((_vm.paged_species.data.data),function(item,ps){return _c('v-flex',{key:ps,staticClass:"pa-6 pt-0",attrs:{"md4":"","sm6":"","xs12":""}},[_c('v-hover',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var hover = ref.hover;
return [_c('div',{staticClass:"pb-8"},[_c('v-card',{staticClass:"rounded-xl mb-5 mx-auto",class:{ 'on-hover': hover },staticStyle:{"cursor":"pointer"},attrs:{"width":"100%","elevation":hover ? 12 : 5},on:{"click":function($event){return _vm.speciesView(item.id)}}},[_c('v-img',{attrs:{"src":item.display_photo ? item.display_photo : '/img/sample_shell.jpg'}})],1),_vm._v(" "),_c('v-card',{staticClass:"rounded-xl electric_blue white--text pa-3 mb-6 mx-auto",class:{ 'on-hover': hover },attrs:{"elevation":hover ? 12 : 5,"width":"100%"}},[_c('div',{staticClass:"kollektif font-weight-bold"},[_c('div',{staticClass:"text-h6 font-weight-bold text-truncate"},[_vm._v(_vm._s(item.common_name && item.common_name))]),_vm._v(" "),_c('div',{staticClass:"text-body-1 font-italic text-truncate"},[_vm._v(_vm._s(item.name && item.name))])])])],1)]}}],null,true)})],1)}),1),_vm._v(" "),(_vm.paged_species && _vm.paged_species.pagination)?_c('v-pagination',{staticClass:"float-right pt-n8",attrs:{"length":_vm.paged_species.pagination.last_page,"total-visible":_vm.paged_species.pagination.per_page,"rounded":"circle","elevation":"0"},model:{value:(_vm.page),callback:function ($$v) {_vm.page=$$v},expression:"page"}}):_vm._e()],1):_c('v-layout',{staticClass:"rounded-lg",staticStyle:{"background-color":"lightgrey"},attrs:{"wrap":"","align-center":"","justify-center":"","row":"","fill-height":""}},[_c('div',{},[_vm._v("\n          No items found\n        ")])])],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/species/index.vue?vue&type=template&id=1bad2cff&
...
var speciesvue_type_script_lang_js_ = __webpack_require__(263);

// CONCATENATED MODULE: ./pages/species/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_speciesvue_type_script_lang_js_ = (speciesvue_type_script_lang_js_["a" /* default */]); 
...
var delayable = __webpack_require__(36);
...
var VPagination = __webpack_require__(294);
...
var intersectable = __webpack_require__(101);
...
var VSkeletonLoader = __webpack_require__(296);
...
// CONCATENATED MODULE: ./pages/species/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_speciesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var species = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VFlex: VFlex["a" /* default */],VHover: VHover,VImg: VImg["a" /* default */],VLayout: VLayout["a" /* default */],VPagination: VPagination_VPagination,VRow: VRow["a" /* default */],VSelect: VSelect["a" /* default */],VSheet: VSheet["a" /* default */],VSkeletonLoader: VSkeletonLoader["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
